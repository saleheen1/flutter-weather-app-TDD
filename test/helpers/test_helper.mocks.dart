...
// in flutter_weather_app_tdd/test/helpers/test_helper.dart.
...
import 'package:flutter_weather_app_tdd/core/error/failure.dart' as _i7;
import 'package:flutter_weather_app_tdd/data/data_sources/weather_remote_data_source.dart'
    as _i9;
import 'package:flutter_weather_app_tdd/data/models/weather_model.dart' as _i3;
import 'package:flutter_weather_app_tdd/domain/entities/weather.dart' as _i8;
...
class MockGetCurrentWeather extends _i1.Mock implements _i10.GetCurrentWeather {
  ...
  @override
  _i6.Future<_i2.Either<_i7.Failure, _i8.Weather>> call(String? cityName) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [cityName],
